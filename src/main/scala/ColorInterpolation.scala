...
object ColorSchemes {
  ...
  val NineClassSpectralRev = NineClassInterpolation(
    nine = RGBColor(213, 62, 79),
    eight = RGBColor(244, 109, 67),
    seven = RGBColor(253, 174, 97),
    six = RGBColor(254, 224, 139),
    five = RGBColor(255, 255, 191),
    four = RGBColor(230, 245, 152),
    three = RGBColor(171, 221, 164),
    two = RGBColor(102, 194, 165),
    one = RGBColor(50, 136, 189)
  )
